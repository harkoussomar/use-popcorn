  ...
  return (
    <>
      <NavBar>
        ...
        <MoviesCountDisplay movies={movies} />
      </NavBar>
      <Main>
        <Box>
          {!isloading && !error && (
...
function MoviesCountDisplay({ movies }) {
  return (
...
function UnwatchedMoviesList({ movies, onSelectedMovie, onAddWatched }) {
  return (
    <>
...
function UnwatchedMovieItem({ movie, onSelectedMovie }) {
  return (
